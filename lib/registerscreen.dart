...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  String urlRegister =
      "http://gohaction.com/GohSianHang262333/musicsy/php/register_user.php";
  TextEditingController _nameEditingController = new TextEditingController();
  TextEditingController _emEditingController = new TextEditingController();
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                                style: TextStyle(color: Colors.white),
                                controller: _emEditingController,
  ...
  String _validatePass(String value) {
    ...
    if (value.isEmpty) {
      ...
      return "Your password need at 4 character";
    } else if (value.length > 16) {
      return "Your password need less than 16 character";
    } else if (!regExp.hasMatch(value)) {
      return "Your password must at least one contain special character";
    }
    return null;
  }
